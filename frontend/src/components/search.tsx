...
export function Search({
  ...
  return (
    <Button
      ...
      variant='outline'
      className={cn(
        'group relative h-8 w-full min-w-0 flex-1 justify-start overflow-hidden rounded-md bg-muted/25 text-sm font-normal text-muted-foreground shadow-none hover:bg-accent sm:w-40 sm:pe-12 md:flex-none lg:w-52 xl:w-64',
        className
      )}
