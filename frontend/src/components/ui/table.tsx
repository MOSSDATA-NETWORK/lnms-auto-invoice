...
function Table({ className, ...props }: React.ComponentProps<'table'>) {
  return (
    <div
      ...
      tabIndex={0}
      className='relative max-w-full min-w-0 overflow-x-auto overscroll-x-contain focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none focus-visible:ring-inset'
    >
      <table
        data-slot='table'
